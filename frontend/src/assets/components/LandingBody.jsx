import React, { useEffect } from "react"; // Виправлено імпорт useEffect
            ...
            <header className={styles.LandingHero} id="main"> 
                <div className={styles.animate}>
                    <div className={styles.LandingHeroContent}>
                        ...
                        <img src={HelloS} className={styles.HelloSticker} alt="Hello Sticker"/>
                        <img src={YouCanS} className={styles.YouCanSticker} alt="You Can Sticker"/>
                    </div>
                </div>
                ...
                <div className={styles.UnderTitleButtons}>
                    {/* Використовуємо звичайні кнопки, стилізація йде через CSS батьківського контейнера */}
