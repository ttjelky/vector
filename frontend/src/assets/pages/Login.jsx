...
const Login = ({isOpen, onClose, onSwitchToRegister, onSwitchToForgot}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('fullUserName', `${firstName} ${lastName}`.trim());
      handleClose();
  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      ...
      >
        <div
          className={`${styles.login} ${closing ? styles.modalClosing : ""}`}
        ...
        >
          ...
          <div className={styles.form}>
            ...
            <section className={styles.underform}>
              <div onClick={handleSwitchToRegister} style={{cursor: "pointer"}}>
                <span>Не маєте акаунту? </span>
                <a>Зареєструватися</a>
              </div>
              <div onClick={handleSwitchToForgot}>
