...
// CriteriaEditor.jsx
//
// Вставити в CreateTournamentModal.jsx:
//   1. Імпортуй компонент: import CriteriaEditor from "./CriteriaEditor";
//   2. Додай стан:  const [criteria, setCriteria] = useState(DEFAULT_CRITERIA);
//   3. Вставити у Step 2 після блоку "Розмір команди" (або після реєстрації):
//
...
//
//   4. У handleSubmit — після api.post('/tournaments/', body) — зберегти критерії:
//
//        if (status === 201) {
...
export default function CriteriaEditor({ criteria, onChange, styles }) {
