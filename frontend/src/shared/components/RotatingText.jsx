...
const RotatingText = forwardRef((props, ref) => {
  ...
  // Предзаміряні ширини всіх слів — контейнер плавно перетікає W0 → W1
  // без колапсу й без сплющування тексту.
  ...
  const measure = useCallback(() => {
    ...
    setWidths(nodes.map(n => (n ? n.offsetWidth : 0)));
  }, [texts]);

  useLayoutEffect(() => {
    measureRefs.current = measureRefs.current.slice(0, texts.length);
    measure();
    let cancelled = false;
  ...
  const targetWidth = widths[currentTextIndex] || 'auto';
